classdef Squish < dagnn.ElementWise
  properties
    dim = 3
    op = 'sum'
  end
  ...
  methods
    function outputs = forward(obj, inputs, params)
      outputs{1} = vl_nnsquish(inputs, obj.dim, obj.op) ;
      obj.inputSizes = cellfun(@size, inputs, 'UniformOutput', false) ;
    end

    function [derInputs, derParams] = backward(obj, inputs, params, derOutputs)
      derInputs = vl_nnsquish(inputs, obj.dim, obj.op, derOutputs{1}, 'inputSizes', obj.inputSizes) ;
      derParams = {} ;
    end
