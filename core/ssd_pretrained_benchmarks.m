...
%
%
% Comparison of models trained in matconvnet/caffe
% ------------------------------------------
%
% The matconvnet training code aims to reproduce the results
% achieved by the caffe training routine.  Using the "zomm out"
% data augmentation scheme described in the updated SSD paper
% the model trained with matconvnet (right column) achieves
% an almost identical mAP on the 2007 test set to the caffe model
% (left column).
%
% Test Set Results:
% -------------- -------------------- ------------------------
%                ssd-pascal-vggvd-300 ssd-mcn-pascal-vggvd-300
% -------------- -------------------- ------------------------
