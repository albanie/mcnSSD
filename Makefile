...
cpp_src+=matlab/src/bits/nnmultiboxdetector.$(ext)
...
mex_src+=matlab/src/vl_nnmultiboxdetector.$(ext)
...
cpp_src+=matlab/src/bits/impl/multiboxdetector_cpu.cpp
...
cpp_src+=matlab/src/bits/impl/multiboxdetector_gpu.cu
