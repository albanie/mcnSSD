...
dataOpts.flipAugmentation = true ;
dataOpts.zoomAugmentation = false ;
dataOpts.patchAugmentation = true ;
dataOpts.useValForTraining = true ;
dataOpts.distortAugmentation = true ;
...
switch opts.dataOpts.trainData
    ...
    otherwise
        error(sprintf('Training data %s not recognized', ...
